...
if __name__ == "__main__":
    urls = superfeed.remove_duplicates(superfeed.flatten(list(map(superfeed.scrape_rss_urls, RSS_URL_ARRAY)))) + superfeed.remove_duplicates(superfeed.flatten(list(map(unstructured.extract_urls, UNSTRUCT_URL_ARRAY))))
